...
<section class="content-main">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <form name="form1" method="post" action="create-category_a-act.php" enctype="multipart/form-data">
                                    <div class="mb-4">
                            ...
                            <div class="col-md-9">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        $a=$mulai+1;
                                        $b=1+$a;			
                                        $result = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM category_a where cat_name like '%".$cari."%'");
                                        $total = mysqli_num_rows($result);
                                        $pages = ceil($total/$halaman); 
                                        $sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM category_a where cat_name like '%".$cari."%' LIMIT $mulai, $halaman") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
                                            ...
                                            $a=$mulai+1;
                                            $b=1+$a;			
                                            $result = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM category_a");
                                            $total = mysqli_num_rows($result);
                                            $pages = ceil($total/$halaman); 
                                            $sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM category_a LIMIT $mulai, $halaman") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
                                        }    
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="edit-category_a-page.php?cat_id=<?php echo $d['cat_id'];?>">Edit info</a>
                                                            <a class="dropdown-item text-danger" href="delete-category_a-act.php?cat_id=<?php echo $d['cat_id'];?>">Delete</a>
                                                        </div>
                                                    </div>
                                                    <!-- dropdown //end -->
                                                </td>
