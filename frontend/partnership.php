					...
					<div class="top-row mb-80">
						...
						<div class="col-lg-6">
							<div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
								<img style="border-radius: 10%;" width="100%" class="img-fluid" src="images/chief_doctor_700x800.jpg" alt="info-image">
							</div>
						</div>
...
<!-- ABOUT-5
			...
			<section id="about-5" class="pt-100 about-section division" style="background-color:#FFFFFF;" padding-top:50px;">
				<div class="container" style="background-color:#FFFFFF;">
					...
					<div class="col">
					<div class="sbox-3 icon-sm" style="background-color:#ececec; border:none;margin-bottom:0px;padding-bottom:0px;">
					<!-- Icon -->
