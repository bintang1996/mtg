				...
				<div class="slider" style="height: 500px;">
			    	<ul class="slides">
				     	...
				     	<!-- SLIDE #1 -->
								...
								<img class="img-fluid" width="100%" height="500px" src="images/head/partnership.jpg" alt="hero-image">
				...
				<div class="container" style="background-color:#FFFFFF;">
						...
						<div class="col-lg-6">
							<div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
								<img style="border-radius: 10%;" width="100%" class="img-fluid" src="images/partnership/dokterketawa.jpg" alt="info-image">
							</div>
						</div>
				...
				<div class="row">	
					...
					<div class="bottom-row" >
						...
						<div class="row d-flex align-items-center" >
							...
							<table>
								<tr>
									<td><img class="img-fluid" width="120px" style="border-radius: 15px;" src="images/partnership/centangbiru.png" alt="tab-image" /></td>
									...
									<div class="row d-flex align-items-center">
										...
										<div class="col-lg-6">
											<div class="txt-block pc-30">
												...
												<!-- Button -->
												<a href="https://wa.me/+6281280001102" class="btn btn-blue orange-hover mt-30">Hubungi Kami</a>
									...
									<div class="row d-flex align-items-center">
										...
										<div class="col-lg-6">
											<div class="txt-block pc-30">
												...
												<!-- Button -->
												<a href="https://wa.me/+6281280001102" class="btn btn-blue orange-hover mt-30">Lebih Lanjut</a>
