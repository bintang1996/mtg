			...
			<section id="services-3" class="bg-lightgrey wide-100 services-section division" style="background-color:white;">
				<div class="container">
					...
					<div class="row text-center">	
						...
						<i class="fas fa-home" style="font-size:200px;"></i><BR><br><BR><B>ADDRESS</B><BR><BR><P>JL. MUNGGANG NO. 86 - 87 BALEKAMBANG,<BR>
						KRAMAT JATI, JAKARTA TIMUR 13530<P>

						</div> 
						<div class="col">		
							
						<i class="fas fa-mobile" style="font-size:200px;"></i><BR><br><BR><B>ADDRESS</B><BR><BR><P>JL. MUNGGANG NO. 86 - 87 BALEKAMBANG,<BR>
						KRAMAT JATI, JAKARTA TIMUR 13530<P>							
						</div> 
						<div class="col">		
						<i class="fas fa-envelope" style="font-size:200px;"></i><BR><br><BR><B>ADDRESS</B><BR><BR><P>JL. MUNGGANG NO. 86 - 87 BALEKAMBANG,<BR>
						KRAMAT JATI, JAKARTA TIMUR 13530<P>
