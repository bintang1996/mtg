			...
			<section id="about-1" class="about-section division inilohilangin" >
				<div class="container">
					<div class="row d-flex align-items-center">
						...
						<!-- ABOUT BOX #3 -->
						<div id="abox-3" class="col-md-12 col-lg-3" style="margin-right:2%; border-radius:20%; min-width:32%; max-width:32%;">
						...
						<!-- ABOUT BOX #2 -->
						<div id="abox-2" class="col-md-12 col-lg-3" style="margin-right:2%; border-radius:20%; min-width:32%; max-width:32%;">
							<div class="abox-1 white-color" style="padding:47px;" >
						...
						<!-- ABOUT BOX #4 -->
						<div id="abox-4" class="col-md-12 col-lg-3" style="border-radius:20%; min-width:32%; max-width:32%">
							<div class="abox-1 white-color" style="padding:47px;">
...
.gambar{
  ...
  background-position: center;
		...
		<section id="info-4" class="wide-100 info-section division" style="background-color: #f8f9fa; padding-bottom: 80; margin-bottom: 0px; ">
			...
			<p style="text-align:justify;">Dengan banyak pengalaman yang kami miliki, Anda tidak perlu ragu untuk bermitra dan bekerjasama dengan kami. Kami selalu siap memberikan yang terbaik untuk Anda."</p>
				...
				<br><a href="https://mtg.sticare.co.id/frontend/company-profile.php" class="btn btn-md btn-orangemeditrans blue-hover">Selengkapnya</a>
				</div>    <!-- End row -->
				</div>	<!-- END SECOND ROW -->
				...
				<div class="container">
                    ...
                    $r=$_GET['id'];
							...
							<?php } ?>
										...
										<!-- Testimonial Text -->
										<p style="font-size: 0.5em; margin:0px;"><?php $rt=$d1['p_desc']; echo substr("$rt", 0, 100); ?>... <a style="font-size: 1em; color:blue;" href="article-details.php?id=<?php echo $d1['id']; ?>">Read more.</a></p>
