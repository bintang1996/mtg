				...
				<div class="container">
					...
					<div class="row d-flex align-items-center text-center">
						<div class="col">
								...
								<?php
							$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM category where cat_desc='Brand' and cat_name !='QFR' ") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
							while($d=mysqli_fetch_array($sql)){
							?> 
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">					
							...
							<?php
                    $r=$_GET['id'];
							$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM collections_a where cat_name = 'NEWS' OR cat_name = 'EDUCATION' OR cat_name = 'OUR STORIES' limit 6") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
							while($d=mysqli_fetch_array($sql)){ $x=$d['p_id'];
                                $sql1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM artikel where id='$x' order by id desc") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
                                while($d1=mysqli_fetch_array($sql1)){ 
							?> 
							...
							<?php } ?>
										...
										<!-- Testimonial Text -->
										<p style="font-size: 0.5em; margin:0px;"><?php $rt=$d1['p_desc']; echo substr("$rt", 0, 100); ?>... <a style="font-size: 1em; color: #e86845;" href="article-details.php?id=<?php echo $d1['id']; ?>">Lebih lanjut.</a></p>
