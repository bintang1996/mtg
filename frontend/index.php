					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title" style="margin-bottom: 30px;">		
							...
							<?php
                                ...
                                $sql1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM artikel where id='$x' limit 3 ORDER BY ID desc") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
