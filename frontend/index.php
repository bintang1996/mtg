...
<br><br>
			...
			<table class="table" width="100%" style="border:none; margin-bottom:0; margin-right:2%;">
			...
			<table class="table" width="100%" style="border:1px; margin-bottom:0; margin-right:2%;">
			<tr><td width="50%" class="text-center align-center">
			<img class="img-fluid"  width="70%" src="images/pediatrics_700x700.jpg" alt="tab-image">
			</td>
			<td>
