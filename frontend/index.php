...
<br><br>
    ...
    background-color: red;
			...
			<div class="w3-center w3-container w3-section w3-large w3-text-white w3-display-bottommiddle" style="width:100%">
				...
				<span class="w3-badge demo w3-border w3-white w3-hover-red" onclick="currentDiv(1)"></span>
				<span class="w3-badge demo w3-border w3-white w3-hover-red" onclick="currentDiv(2)"></span>
				<span class="w3-badge demo w3-border w3-white w3-hover-red" onclick="currentDiv(3)"></span>
			</div>
			</div>
