				...
				<div class="container">
					...
					<div class="row d-flex align-items-center text-center">
						<div class="col">
							...
							<a href="product-brands.php?id=<?php echo $d['cat_name']; ?>"><img class="img-fluid" max-width="200px" max-height="30px" src="assets/imgs/vendor/<?php echo $d['logo']; ?>" style="padding-right:20px; padding-bottom:25px;"></a>
