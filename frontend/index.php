...
<div class="w3-center w3-container w3-section w3-large w3-text-white w3-display-bottommiddle" style="width:100%">
	...
	<span class="w3-badge demo1 w3-border w3-red w3-hover-red" onclick="currentDiv(5)"></span>
	<span class="w3-badge demo1 w3-border w3-red w3-hover-red" onclick="currentDiv(6)"></span>
