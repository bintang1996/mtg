					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title" style="margin-bottom: 30px;">		
							...
							<?php
                                ...
                                $sql1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM artikel where id='$x' ORDER BY id desc limit 3") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
