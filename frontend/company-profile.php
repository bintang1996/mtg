		...
		<img class="img-fluid" style="border-radius: 10%;" src="images/tentang-kami.png" alt="info-image">
						...
						<div class="col-lg-6">
							<div class="txt-block pc-30 mb-40 wow fadeInUp" data-wow-delay="0.4s">
								...
								&emsp;&emsp; PT. Meditrans Global berdiri sejak tahun 2012 di Surabaya, berawal dari bisnis penyedia barang dan jasa, seiring waktu Meditrans terus berkembang ke bidang bidang bisnis lainnya.<br>

								&emsp;&emsp; Berlatar belakang pendiri perusahaan yang memiliki pengalaman di bidang peralatan penunjang kesehatan, saat ini Meditrans fokus dalam pengembangan perusahaan dalam hal pelayanan Barang dan Jasa penunjang kesehatan.<br>

								&emsp;&emsp; Di dukung dengan tim yang solid dan berpengalaman, Meditrans bekerjasama dengan Rumah Sakit serta perusahaan penyedia peralatan kesehatan, baik principal ataupun pihak Public Private Partnership (PPP) dalam memberikan konsultasi dan pelaksanaan pekerjaan. Yakni meliputi Pra Instalasi peralatan kesehatan seperti instalasi X-Ray, CT-Scan, MRI dan Cathlab.<br>

								&emsp;&emsp; Meditrans juga berpengalaman dalam hal Konstruksi dan Renovasi untuk ruangan Operasi, ruang radiologi yang membutuhkan instalasi anti radiasi (Timbal Pb) maupun struktur penguat lantai dan rangka atas.<br>

								&emsp;&emsp; Meditrans telah banyak bekerjasama dan memiliki jaringan yang luas dengan banyak perusahaan besar seperti Aneka Gas, Siemens Healthcare, GE Healthcare dan banyak Rumah Sakit Pemerintah ataupun Swasta.</p>
							</div>
						</div>	<!-- END TEXT BLOCK -->	
