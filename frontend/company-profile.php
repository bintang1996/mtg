				...
				<div class="container">
					...
					<div class="col-lg-12 text-center" style="margin-bottom:30px;">		
						...
						<table style="border:none;"><tbody style="border:none;"><tr style="border:none;"><td>
										...
										<!-- Icon -->
										<img class="img-fluid" src="images/pimpinan/01.png" alt="doctor-foto" style="border-top-left-radius:20px; border-top-right-radius:20px; width: 252px;">	
...
<td>
										...
										<!-- Icon -->
										<img class="img-fluid" src="images/pimpinan/02.png" alt="doctor-foto" style="border-top-left-radius:20px; border-top-right-radius:20px; width: 252px;">	
...
<td>
										...
										<!-- Icon -->
										<img class="img-fluid" src="images/pimpinan/03.png" alt="doctor-foto" style="border-top-left-radius:20px; border-top-right-radius:20px; width: 252px;">	
