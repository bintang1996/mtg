				...
				<div class="container">
					...
					<div class="col-lg-12 text-center" style="margin-bottom:30px;">		
						...
						<table style="border:none;"><tbody style="border:none;"><tr style="border:none;"><td width="23%">
										...
										<a href="https://www.linkedin.com/in/tari-pristiyanti-266057162/"><h5 class="h5-xs steelblue-color">Ibnu Affan</h5></a>
...
<td td width="23%">
										...
										<!-- Icon -->
										<img class="img-fluid" src="images/pimpinan/03.png" alt="doctor-foto" style="border-top-left-radius:20px; border-top-right-radius:20px; width: 100%;">	
