	...
	<!-- SERVICES-3
			...
			<section id="services-3" class="bg-lightgrey wide-100 services-section division" style="background-color:white; padding-bottom:0px;">
				<div class="container">
					...
					<div class="row text-center">	
						...
						<i class="fas fa-map-marked-alt" style="font-size:60px;"></i><BR><br><B>ADDRESS</B><BR><BR><P>JL. MUNGGANG NO. 86 - 87 BALEKAMBANG,<BR>
						KRAMAT JATI, JAKARTA TIMUR 13530<P>

						</div> 
						<div class="col">		
							
						<i class="fas fa-mobile-alt" style="font-size:60px;"></i><BR><br><B>PHONE</B><BR><BR><P>HOTLINE: (+62) 21 2204 7248<BR>
						SERVICE CENTER: (+62) 81 28000 1102<P>							
						</div> 
						<div class="col">		
						<i class="fas fa-mail-outline" style="font-size:60px;"></i><BR><br><B>EMAIL</B><BR><BR><P>INFO@MEDITRANS.ID<BR>
						CS@MEDITRANS.ID<P>
			...
			<!-- FOOTER-1
			============================================= -->
			<footer id="footer-1" class="wide-40 footer division" style="background-color:white; padding-top:10px;">
				<div class="container">
