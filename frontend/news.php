				...
				<div class="container">
                    ...
                    $r=$_GET['id'];
							...
							<?php } ?>
										...
										<!-- Testimonial Text -->
										<p style="font-size: 0.7em;" ><?php $rt=$d1['p_desc']; echo substr("$rt", 0, 100); ?> ... <a style="font-size: 1rem; color:blue;" href="article-details.php?id=<?php echo $d1['id']; ?>">Read more.</a>
										</p>				
