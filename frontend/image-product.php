...
<style>
    ...
    background-color: red;}
		...
		<div class="w3-content w3-display-container" style="max-width:100%; background-color:#fff; padding-top:25px; padding-bottom:5px;">
            ...
            <button class="w3-display-left w3-grey" style="margin-left:2%;" onclick="plusDivs(-1)">&#10094;</button>
			<button class="w3-display-right w3-grey" style="margin-right:2%;" onclick="plusDivs(1)">&#10095;</button>
