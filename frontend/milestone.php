...
<div class="container">
    		<div class="row">
              ...
              <img style="border-top-left-radius: 20px; border-top-right-radius: 20px; width: 298px; height: 186.25px;" class="img-fluid" src="images/Milestone/2012.JPG" alt="doctor-foto">	
              	<!-- Icon -->
								<br>	<br>
            ...
            <li class="timeline-item">
							<div class="timeline-badge primary orange-hover">2015</div>
							<div class="timeline-panel">
              <img style="border-top-left-radius: 20px; border-top-right-radius: 20px; width: 298px; height: 186.25px;" class="img-fluid" src="images/Milestone/2015-1.jpeg" alt="doctor-foto">	
              	<!-- Icon -->
								<br>	<br>
						...
						<li class="timeline-item">
							...
							<div class="timeline-panel">
              <img style="border-top-left-radius: 20px; border-top-right-radius: 20px; width: 298px; height: 186.25px;" class="img-fluid" src="images/Milestone/2016-1.jpeg" alt="doctor-foto">	
              	<!-- Icon -->
								<br>	<br>
            ...
            <li class="timeline-item">
							...
							<div class="timeline-panel">
              <img style="border-top-left-radius: 20px; border-top-right-radius: 20px; width: 298px; height: 186.25px;" class="img-fluid" src="images/Milestone/2018.JPG" alt="doctor-foto">	
              	<!-- Icon -->
								<br>	<br>
            ...
            <li class="timeline-item">
							...
							<div class="timeline-panel">
              <img style="border-top-left-radius: 20px; border-top-right-radius: 20px; width: 298px; height: 186.25px;" class="img-fluid" src="images/Milestone/2020.JPG" alt="doctor-foto">	
              	<!-- Icon -->
								<br>	<br>
            ...
            <li class="timeline-item">
							...
							<div class="timeline-panel">
              <img style="border-top-left-radius: 20px; border-top-right-radius: 20px; width: 298px; height: 186.25px;" class="img-fluid" src="images/Milestone/2022.jpg" alt="doctor-foto">	
              	<!-- Icon -->
								<br>	<br>
