				 	...
				 	<div class="row">
                         ...
                         <div id="tabs-nav" class="list-group text-center clearfix" style="padding-bottom: 80px;">
                                ...
                                <div id="collapseThree" class="collapse  show" data-parent="#accordion">
									...
									<!-- TAB-1 LINK -->
									<li class="nav-item icon-xs">
                                            <a class="nav-link active" id="tab26-list" data-toggle="pill" href="#tab-26" role="tab" aria-controls="tab-26" aria-selected="true">
											<b>Medis Medical Imaging</b>
                                            </a>
                                        </li>
...
<!-- TAB-4 CONTENT -->
								<div class="tab-pane fade show active" id="tab-26" role="tabpanel" aria-labelledby="tab14-list">
