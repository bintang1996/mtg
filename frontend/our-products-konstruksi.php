				 	...
				 	<div class="row">
                         ...
                         <div id="tabs-nav" class="list-group text-center clearfix" style="padding-bottom: 80px;">
                                ...
                                <div class="card-header" style="background-color: #fff;">
                                    ...
                                    <b style="color: #214068;">LABORATORIUM</b>
                                </a>
                                </div>
                                ...
                                <div id="collapseFive" class="collapse show" data-parent="#accordion" style="border-bottom: 0px;">
                                    <div class="card-body" >
                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                       <!-- TAB-1 LINK -->
                                        <li class="nav-item icon-xs">
                                            <a class="nav-link active" id="tab24-list" data-toggle="pill" href="#tab-24" role="tab" aria-controls="tab-24" aria-selected="true">
				...
				<!-- PRODUK NI BOS -->	
							...
							<!-- TAB-4 CONTENT -->
								<div class="tab-pane fade" id="tab-18" role="tabpanel" aria-labelledby="tab14-list">
									...
									<!-- Title -->
									<table style="border: none;" width="100%"><tr><td>
									<h3 class="h3-md steelblue-color">Del Medical
										</h3>
										</td>
									<td style="text-align: right; align:right;">
									<?php
	...
	<!-- PRODUK NI BOS -->	
								...
								<div class="tab-pane fade" id="tab-22" role="tabpanel" aria-labelledby="tab14-list">
									...
									<h3 class="h3-md steelblue-color">ZYBIO</h3>
										...
										<?php
										$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM category where cat_name='Zybio'") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
										while($d=mysqli_fetch_array($sql)){
										?> 
				...
				<!-- PRODUK NI BOS -->	
								...
								<div class="tab-pane fade" id="tab-23" role="tabpanel" aria-labelledby="tab14-list">
									...
									<h3 class="h3-md steelblue-color">Yokogawa</h3>
										...
										<a href="product-brands.php?id=<?php echo $d['cat_name']; ?>"><img class="img-fluid lugi" width="200px" src="assets/imgs/vendor/<?php echo $d['logo']; ?>" style="padding-right:20px; padding-bottom:25px; width: 200px; height: auto;"></a>
...
Pengujian dan Pengukuran. Menggabungkan teknologi unggul dengan layanan teknik, manajemen proyek, dan pemeliharaan, Yokogawa memberikan efisiensi, keamanan, kualitas, dan keandalan operasional yang terbukti di lapangan.
				...
				<!-- PRODUK NI BOS -->	
								...
								<!-- TAB-4 CONTENT -->
								<div class="tab-pane fade show active" id="tab-24" role="tabpanel" aria-labelledby="tab14-list">
...
<!-- TAB-4 CONTENT -->
	...
	<!-- PRODUK NI BOS -->	
				...
				<h3 class="h3-md steelblue-color">Osirix PACS</h3>
					...
					<?php
					$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM category where cat_name='osirix'") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
					while($d=mysqli_fetch_array($sql)){
					?> 
...
komputer untuk penyimpanan jangka pendek dan panjang, pengambilan, pengelolaan, distribusi, dan penyajian gambar medis. Peralatan medis dapat secara otomatis menyimpan gambar medis di server PACS. Komputer lain, yang dilengkapi dengan OsiriX, dapat menyimpan dan mengambil gambar langsung dari server PACS.
				...
				<?php
				$r=$_GET['id'];
				$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM collections where cat_name='osirix'") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
				while($d=mysqli_fetch_array($sql)){ $x=$d['p_id'];
				$sql1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM product where id='$x'") or die ("Query gagal dengan error: ".mysqli_error($GLOBALS["___mysqli_ston"]));
				while($d1=mysqli_fetch_array($sql1)){ 
				?> 
