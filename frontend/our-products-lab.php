				 	...
				 	<div class="row">
                         ...
                         <div id="tabs-nav" class="list-group text-center clearfix">
                                ...
                                <div id="collapseFour" class="collapse" data-parent="#accordion">
									...
									<li class="nav-item icon-xs">
                                            <a class="nav-link active" id="tab23-list" data-toggle="pill" href="#tab-23" role="tab" aria-controls="tab-23" aria-selected="TRUE">
											<b>Yokogawa</b>
                                            </a>
                                        </li>   
                                       <!-- TAB-1 LINK -->
...
diri dalam R&D, manufaktur, penjualan, dan layanan teknis reagen dan peralatan diagnostik in vitro, dengan kantor pusat dan pusat manufaktur yang berlokasi di Distrik Dadukou, Chongqing.
				...
				<!-- PRODUK NI BOS -->	
								...
								<!-- TAB-4 CONTENT -->
								<div class="tab-pane fade show active" id="tab-23" role="tabpanel" aria-labelledby="tab14-list">
