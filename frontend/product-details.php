...
<!-- HERO-2
				...
				<div class="slider" style="height: 500px;">
			    	<ul class="slides">
				     	...
				     	<!-- SLIDE #1 -->
								...
								<img class="img-fluid" width="100%" height="500px" src="images/detail_produk.jpg" alt="hero-image">
		       						...
		       						<div class="row" >
		       							<div class="col-md-12 col-lg-10" >
		       								<div class="caption-txt">
						       					<!-- Title -->
						       					<h3 class="white-color judul1" style="font-family: Lato; font-weight: 700;">DETAIL PRODUK</h3>
			...
			<!-- INFO-4
			============================================= -->
			<section id="info-4" class="wide-100 info-section division" style="background-color:white;padding-bottom:10px;border-bottom: 1px solid #ececec; ">
				<div class="container">
