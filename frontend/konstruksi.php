	...
	<!-- HERO-2
		       						...
		       						<div class="row" >
		       							<div class="col-md-12 col-lg-10" >
		       								<div class="caption-txt">
						       					<!-- Title -->
						       					<h3 class="white-color judul1">KONSTRUKSI</h3>
			...
			<section id="info-4" class="wide-100 info-section division" style="background-color:#ececec;  padding-top: 80px; padding-bottom: 80px;">
				<div class="container">
						...
						<div class="" style="margin-bottom:30px;">		
							<!-- Title 	-->	
							<h3 class="h4-md steelblue-color" style="color: #214068; PADDING-LEFT: 15PX;"><b><b>JASA KONSTRUKSI <br>RUANG CT-SCAN </b></b></h3>								
						</div> 
					</div>
			...
			<section id="info-4" class="wide-100 info-section division" style="background-color:#ececec; padding-bottom: 80px; padding-top:80px;">
				<div class="container" >
						...
						<div class="col-lg-6">
							<div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
								<img style="border-radius: 20px;" class="img-fluid" src="images/MOT.png" alt="info-image">
							</div>
						</div>
					</div>    <!-- End row -->
				</div>	<!-- END SECOND ROW -->
